...
public class ProviderExceptionMapper implements ExceptionMapper<Exception> {
	...
	public Response toResponse(Exception exception) {
		if (exception instanceof javax.ws.rs.WebApplicationException) {
			...
			LOG.error(Constantes.ERROR_COR + WebApplicationException.class + Constantes.COR_GUION + e.getMessage() + Constantes.COR_DERECHA, e);
			...
			LOG.error(Constantes.ERROR_COR + JsonParseException.class + Constantes.COR_GUION + exception.getMessage() + Constantes.COR_DERECHA, exception);
			return Response.status(Status.BAD_REQUEST).entity(new ApiResponse(ApiResponse.ERROR, "Entrada incorrecta"))
					.build();
		} else if (exception instanceof NotFoundException) {
			LOG.error(Constantes.ERROR_COR + WebApplicationException.class + Constantes.COR_GUION + exception.getMessage() + Constantes.COR_DERECHA, exception);
			...
			LOG.error(Constantes.ERROR_COR + BadRequestException.class + Constantes.COR_GUION + exception.getMessage() + Constantes.COR_DERECHA, exception);
			...
			LOG.error(Constantes.ERROR_COR + ApiException.class + Constantes.COR_GUION + exception.getMessage() + Constantes.COR_DERECHA, exception);
			...
			LOG.error(Constantes.ERROR_COR + BadUsageException.class + Constantes.COR_GUION + exception.getMessage() + Constantes.COR_DERECHA, exception);
			...
			LOG.error(Constantes.ERROR_COR + exception.getMessage() + Constantes.COR_DERECHA, exception);
